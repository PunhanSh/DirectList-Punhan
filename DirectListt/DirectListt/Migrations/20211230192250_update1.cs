        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Ingredient = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationText = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DreamTitle = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    DreamSubTitle = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReserveName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantToFeatures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RestaurantToFeatures_Features_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantToFeatures_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantToMenus", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RestaurantToMenus_Menus_MenuId",
                        column: x => x.MenuId,
                        principalTable: "Menus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantToMenus_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantToTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RestaurantToTags_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantToTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantToFeatures_FeatureId",
                table: "RestaurantToFeatures",
                column: "FeatureId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantToFeatures_RestaurantId",
                table: "RestaurantToFeatures",
                column: "RestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantToMenus_MenuId",
                table: "RestaurantToMenus",
                column: "MenuId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantToMenus_RestaurantId",
                table: "RestaurantToMenus",
                column: "RestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantToTags_RestaurantId",
                table: "RestaurantToTags",
                column: "RestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantToTags_TagId",
                table: "RestaurantToTags",
                column: "TagId");
        }

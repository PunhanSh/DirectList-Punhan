#pragma checksum "C:\Users\TUF DASH\source\repos\DirectListt\DirectListt\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "309a85f5683e03246a05c6c32d7eb596d025176c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"309a85f5683e03246a05c6c32d7eb596d025176c", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\TUF DASH\source\repos\DirectListt\DirectListt\Views\Home\Index.cshtml"
            ...
            <div class=""fw-carousel-item"">
                <div class=""category-box-container text-center"">
                    <div class=""category-box"">
                        ...
                        <div class=""c");
            WriteLiteral(@"ategory-box-background"" style=""background-image: url('assets/images/cat-img-5.jpg')"">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class=""category-box-container text-center"">
                    <div class=""category-box"">
                        <div class=""category-box-content"">
                            ...
                            <h3><a href=""JavaScript:Void(0);"" class=""text-white"">Eat & ");
            WriteLiteral(@"Drink</a></h3>
...
<div class=""block-space bg-secondary"">
   ...
   ");
            WriteLiteral(@"                             <div class=""listing-item text-center"">
            ...
            WriteLiteral(@"               </div>
                    ...
                    <div class=""carousel-item"">
                        <div class=""category-box-container text-center"">
                            <div class");
            WriteLiteral(@"=""listing-item-container"">
                                <div class=""listing-item text-center"">
                                    <div class=""mostviewed-bg"" style=""background-image: url('assets/images/most-img-2.jpg')"">
                                        <div class=""listing-item-content"">
                                            ...
                                            <span class=""badge badge-pill badge-primary text-uppercase open-close-banner"">Ope");
            WriteLiteral(@"n</span>
                                        </div>
                                        <span class=""round-pill like-banner d-block bg-primary""><i class=""fa fa-heart-o""></i></span>
                                    </div>
                            ...
                            <div class=""listing-item-container"">
                                <div class=""listing-item text-center"">
                                    <div class=""mostviewed-bg"" style=""background-image: url('assets/images/most-img-1.jpg')"">
                                        <div class=""listing-item-content"">
                                            <div class=""list-logo"">
                                                <a> <img src=""assets/images/logo-4.png"" width=""80"" height=""80"" alt=""lis");
            WriteLiteral(@"t-logo""></a>
                                            </div>
                                            <span class=""badge badge-pill badge-primary text-uppercase category-banner"">Eat & Drink</span>
    ...
    <div class=""container"">
        <div class=""row row-grid mt-5"">
            <div class=""col-lg-4 text-center"">
                ...
                <p class=""text-white mt-3"">Proin dapibus nisl ornare diam varius tempus. Aenean a quam luctus, finibus tellus ut, convallis ");
            WriteLiteral(@"eros sollicitudin turpis.</p>
            </div>
            <div class=""col-lg-4 text-center"">
                <div class=""icon icon-lg icon-shape bg-gradient-white shadow rounded-circle text-primary"">
                    ...
                    <div class=""col-lg-4"">
                        <div class=""card card-lift--hover shadow border-0"">
                            ...
                            <div class=""card-body py-4"">
                                ...
                                <p>22 August 2018</p>
                                <p class=""description mb-4"">Sed sed tristique nibh iam porta volutpat finibus. Donec in aliquet urneget mattis lorem. ");
            WriteLiteral(@"Pellentesque pellentesque</p>
